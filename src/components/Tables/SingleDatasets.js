...
import {Tooltip,handleOver,handleOut} from './utils'
...
const ntSchStd = 'note-sch-std'
const ntSchStdColB = '#c21c1c50'
const ntSchStdColT = '#c21c1cFF'
  ...
  return (
    <div>
        ...
        <table class="results">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className={ntSchStd}><b>0.5850 ± 0.44</b></td>
            </tr>
            <tr>
              <th scope="row">Statistical</th>
              <td><u>0.5751 ± 0.23</u></td>
              <td className={ntHgrEasy}><u>0.8434 ± 0.19</u></td>
              <td className={ntSchStd}><u>0.4303 ± 0.34</u></td>
            </tr>
            <tr>
              <th scope="row">Thresholding</th>
              <td>0.5088 ± 0.25</td>
              <td className={ntHgrEasy}>0.6467 ± 0.30</td>
              <td className={ntSchStd}>0.3323 ± 0.28</td>
            </tr>
            <tr>
              ...
              <td className={ntSchStd}><b>0.5520 ± 0.64</b></td>
            </tr>
            <tr>
              <th scope="row">Statistical</th>
              <td><u>0.4226 ± 0.27</u></td>
              <td className={ntHgrEasy}><u>0.1524 ± 0.19</u></td>
              <td className={ntSchStd}><u>0.7120 ± 0.54</u></td>
            </tr>
            <tr>
              <th scope="row">Thresholding</th>
              <td>0.5340 ± 0.32</td>
              <td className={ntHgrEasy}>0.3936 ± 0.36</td>
              <td className={ntSchStd}>0.8148 ± 0.48</td>
            </tr>
          </tbody>
        </table>
      </div>
      <div class='col col--8 col--offset-2'>
        <ul>
          <li onMouseOver={(e) => handleOver(ntSchStd, ntSchStdColB, e)} onMouseOut={(e) => handleOut(ntSchStd, e)}>
            <p>
            Schmugge presents <span className={styles.underlineDashed} style={{textDecorationColor: ntSchStdColT}}>high standard deviations</span> that can be attribuited to its diverse content, featuring different subjects, backgrounds, and lighting.
            </p>
          </li>
          <li onMouseOver={(e) => handleOver(ntHgrEasy, ntHgrEasyColB, e)} onMouseOut={(e) => handleOut(ntHgrEasy, e)}>
            <p>
            HGR seems to be the <span className={styles.underlineDashed} style={{textDecorationColor: ntHgrEasyColT}}>easier dataset to classify</span>, which can be due to the relatively low diversity of subjects and backgrounds. In fact, learning approaches tend to have very high measurements.
            </p>
          </li>
          <li>
