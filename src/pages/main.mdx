  ...
  <div class="row margin-top--xl reverse-row" >
    <div class="col col--6">
      <div class="row" style={{flexWrap: 'nowrap', justifyContent: 'center'}} >
        <img src="/img/clay.png" style={{maxHeight: '20vh', padding: '0.5rem', minWidth: '0'}} />
        <img src="/img/wood.jpg" style={{maxHeight: '20vh', padding: '0.5rem', minWidth: '0'}} />
      </div>
      <div class="row" style={{flexWrap: 'nowrap', justifyContent: 'center'}}>
        <img src="/img/lighting_1.jpg" style={{maxHeight: '20vh', padding: '0.5rem', minWidth: '0'}} />
        <img src="/img/lighting_2.png" style={{maxHeight: '20vh', padding: '0.5rem', minWidth: '0'}} />
      </div>
    </div>
    <div class="col col--6">
