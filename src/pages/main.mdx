...
Skin detection is the process of **discriminating skin and non-skin pixels**. It is
...
<div class="container margin-bottom--xl">
  ...
  <div class="row margin-top--lg">
    ...
    <div class="col col--6">
      <img src="/img/trapezia_params.png" />
...
<div class="container margin-bottom--xl">
  ...
  <div class="row margin-top--lg">
    <div class="col col--6">
        <h2 class="text--center slight-bold">Workflow</h2>
        <ol class="spacing">
