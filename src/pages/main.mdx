...
human skin can assume and the scene properties, such as lighting and background.
</p>
  ...
  <div class="row">
    ...
    <div class="col col--6">
      ...
      <ul>
        <li>
        <details>
          <summary>Materials with <b>skin-like colors</b></summary>
          <div>
            <div class="row">
              <div class="col col--4">
                <img src="/img/im00060x.jpg" />
              </div>
              <div class="col col--4">
                <img src="/img/im00060y.png" />
              </div>
              <div class="col col--4">
                <img src="/img/im00060p.png" />
              </div>
            </div>
          </div>
        </details>
...
<div class="container margin-bottom--xl">
  ...
  <div class="container margin-top--lg">
    <div class="row">
      <div class="col col--6">
        <div style={{minHeight: "100px"}}>
          <div class="im-container padding-small" >
            <img class="im-itemt" src="/img/inception1.png" class="three-cols" />
            <img class="im-itemt" src="/img/inception2.png" class="three-cols" />
            <img class="im-itemt" src="/img/inception3.png" class="three-cols" />
          </div>
        </div>
        <p>
      ...
      <div class="col col--6">
        <Center>
          <img src="/img/dense.png" style={{height: "100px", padding: "0 0 0.4rem 0"}} />
        </Center>
        <p>
        The salient content size varies between images. <b>Inception module</b> combines multiple kernels with different sizes for content adaptation.
        </p>
