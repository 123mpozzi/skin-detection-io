...
import DatasetTable from '@site/src/components/DatasetTable';
...
<div class='margin-bottom--xl' >
  ...
  <div>
    <Center>
      <table class="results singles">
        <thead>
          <tr>
            <td />
            <th scope="col">Method \ Database</th>
            <th scope="col">ECU</th>
            <th scope="col">HGR</th>
  ...
  <div>
    <div style={{overflow: 'auto', display: 'flex', justifyContent: 'flex-start'}}>
      <table class="results cross">
        <thead>
          <tr>
    ...
    <Center>
      <table class="results">
        <tr>
          ...
          <th>
          <span class='underline-dots' data-tip="Extracted from the original papers or eventual labels" data-for="tip-infer">Improved</span> inference time<br />(seconds)
          </th>
        </tr>
        <tr>
          <td>Deep Learning</td>
        ...
        <tr>
          <td>Thresholding</td>
          <td><b>0.007717 <span class='underline-dots' data-tip="Extracted from the original papers or eventual labels" data-for="tip-inferthresh">± 0.000</span></b></td>
