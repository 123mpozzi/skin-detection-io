...
import { DatasetOverview, SingleDatasets, CrossDatasets } from '@site/src/components/Tables';
    ...
    <div class="table-wrapper">
      <table class="results">
        <tr>
          ...
          <th>
          <span class='underline-dots' data-tip="Deep learning: assume one prediction is already performed before starting the observations. Statistical: create the prediction image looping on a sequence object instead of every pixel." data-for="tip-infer">Improved</span> inference time<br />(seconds)
          </th>
        </tr>
        <tr>
          <td>Deep Learning</td>
        ...
        <tr>
          <td>Thresholding</td>
          <td><b>0.007717 <span class='underline-dots' data-tip="Inference times independent of image content" data-for="tip-inferthresh">± 0.000</span></b></td>
