    ...
    <div class="col col--8">
      <div style={{display: 'flex', alignItems: 'flex-start', justifyContent: 'space-evenly', alignItems: 'center'}}>
        <div style={{display: 'flex', flexWrap: 'nowrap', flexDirection: 'column', justifyContent: 'space-around'}} >
          ...
          <div>
            <img src="/img/applications_ads.png" style={{maxWidth: '90%', maxHeight: '25vh'}} alt='In Digital Out-of-Home advertising, skin detection can be used to infer properties of the audience.' title='Infer audience properties in DOOH ads' />
...
<div class={section} >
    ...
    <ul>
      <li>
        <div class="question-mark">
          Unbalanced classes
          <img src='/img/question_mark.svg' data-tip="Unbalanced data" data-for="tip-unbalance" alt='Question mark logo that makes a tooltip popup: classes in datasets are often unbalanced, with one being much larger than the other, which may cause some metrics to give overoptimistic estimations [36].' />
          <ReactTooltip id="tip-unbalance" place="top" effect="solid">
      ...
      <li>
        <div class="question-mark">
          ...
          <img src='/img/question_mark.svg' data-tip="Additional data" data-for="tip-datalack" alt='Question mark logo that makes a tooltip popup: data about the lighting conditions, background complexity, number of subjects, skin tones, indoor or outdoor scenery of an image may be extremely useful in some applications.' />
          <ReactTooltip id="tip-datalack" place="top" effect="solid">
  ...
  <p>
  Here are the <b>common datasets</b> used in Skin Detection. <br />
  ...
  <div class="row">
    <div class="col col--8 col--offset-2">
      <div id="dataset-tdsd" class="" >
        <p>
        <b>TDSD</b> [10] is the acronym of Test Database for Skin Detection, which is a database featuring 555 full-body skin images. Its ground truths are segmentation masks. It is also referred to as IBTD.
        </p>
      </div>
      <div id="dataset-ecu" class="" >
        <p>
      ...
      <div id="dataset-pratheepan" class="" >
        <p>
